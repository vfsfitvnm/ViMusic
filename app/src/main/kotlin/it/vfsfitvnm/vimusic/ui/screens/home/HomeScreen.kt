        ...
        host {
            ...
            Scaffold(
                ...
                tabColumnContent = { Item ->
                    Item(0, stringResource(id = R.string.quick_picks), R.drawable.sparkles)
                    Item(1, stringResource(id = R.string.songs), R.drawable.musical_notes)
                    Item(2, stringResource(id = R.string.playlists), R.drawable.playlist)
                    Item(3, stringResource(id = R.string.artists), R.drawable.person)
                    Item(4, stringResource(id = R.string.albums), R.drawable.disc)
                }
            ) { currentTabIndex ->
